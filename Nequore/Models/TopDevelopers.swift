...
struct TopDevelopers : Mappable {
	...
	var rent_property_count : Int?
	var sale_property_count : Int?
	var buildings_count : Int?
	var approved_property_count : Int?
	...
	mutating func mapping(map: Map) {
		...
		rent_property_count <- map["rent_property_count"]
		sale_property_count <- map["sale_property_count"]
		buildings_count <- map["buildings_count"]
		approved_property_count <- map["approved_property_count"]
	}
